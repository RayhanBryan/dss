	...
	<div class="col-sm-6">
      ...
      <div class="form-group">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="lat" id="lat" value="<?=$_POST['lat']?>" readonly=""/>
			</div>
			<div class="form-group">
				<label>Longitude <span class="text-danger">*</span></label>
				<input class="form-control" type="text" id="lng" name="lng" value="<?=$_POST['lng']?>" readonly=""/>
			</div>
			<div class="form-group">
        <label>Lokasi</label>
...
<script>
var defaultCenter = {
    lat : -7.790558634576361 * 1, 
    lng : 110.37105294023439 * 1
};
function initMap() {
